  ...
  '''
    ...
    def play_quiz():
        try:
            ...
            # load questions if the "All" option is selected
            if quiz_category['id'] == 0 and previous_questions is not None:
                questions = Question.query.filter(Question.id.notin_(previous_questions)).all()
            elif quiz_category['id'] == 0 and previous_questions is None:
                questions = Question.query.all()

            # load questions for selected category
            elif quiz_category['id'] != 0 and previous_questions is not None:
